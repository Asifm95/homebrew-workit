class Workit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Asifm95/workit/releases/download/v0.1.1/workit-darwin-arm64"
      sha256 "05d4c987639afc75aa12bfd8393dbc7c7adc0aca8c7ea4f70d432fe40d9a1ee4"
    end
    on_intel do
      url "https://github.com/Asifm95/workit/releases/download/v0.1.1/workit-darwin-x64"
